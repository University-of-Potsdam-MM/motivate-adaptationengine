    ...
    var ContextDetector = (function() {
        ...
        function ContextDetector(adaptationRules, verbose) {
            ...
            this._discoverer = new contactJS.Discoverer({
                "(CI_CURRENT_UNIX_TIME:INTEGER)#[CP_UNIT:MILLISECONDS]": "(CI_BASE_UNIT_OF_TIME:INTEGER)#[CP_UNIT:MILLISECONDS]",
                "(CI_OTHER_MILLISECONDS:INTEGER)#[CP_UNIT:MILLISECONDS]": "(CI_BASE_UNIT_OF_TIME:INTEGER)#[CP_UNIT:MILLISECONDS]",
                "(CI_CURRENT_UNIX_TIME:INTEGER)#[CP_UNIT:SECONDS]": "(CI_BASE_UNIT_OF_TIME:INTEGER)#[CP_UNIT:SECONDS]",
                "(CI_OTHER_SECONDS:INTEGER)#[CP_UNIT:SECONDS]": "(CI_BASE_UNIT_OF_TIME:INTEGER)#[CP_UNIT:SECONDS]"
            });
